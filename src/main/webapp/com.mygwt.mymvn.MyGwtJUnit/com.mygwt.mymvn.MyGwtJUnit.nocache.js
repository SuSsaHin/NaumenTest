...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "com.mygwt.mymvn.MyGwtJUnit" because\n';
  ...
  $wnd.__gwt_activeModules['com.mygwt.mymvn.MyGwtJUnit'] = {
    'moduleName' : 'com.mygwt.mymvn.MyGwtJUnit',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/com.mygwt.mymvn.MyGwtJUnit.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['com.mygwt.mymvn.MyGwtJUnit'].superdevmode = true;

  var expectedSuffix = '/com.mygwt.mymvn.MyGwtJUnit.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + com.mygwt.mymvn.MyGwtJUnit + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:com.mygwt.mymvn.MyGwtJUnit';
  var devModeSessionKey = '__gwtDevModeSession:com.mygwt.mymvn.MyGwtJUnit';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/com.mygwt.mymvn.MyGwtJUnit/com.mygwt.mymvn.MyGwtJUnit.nocache.js';
  ...
  $wnd.__gwt_activeModules['com.mygwt.mymvn.MyGwtJUnit'].canRedirect = true;
  $wnd.__gwt_activeModules['com.mygwt.mymvn.MyGwtJUnit'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING com.mygwt.mymvn.MyGwtJUnit';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/com.mygwt.mymvn.MyGwtJUnit?user.agent=' + ua + '&_callback=' + callback;
